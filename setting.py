...
QFrame#settingsFrame {
    ...
    padding: 20px;
        ...
        self.num_questions_input.setRange(0, 20)
        ...
        self.time_input.setRange(0, 120)
    ...
    def submit(self):
        ...
        countdown_time = self.time_input.value()
        
        if self.file_path == "":
            handle_prompt(input_text, number_of_questions, 
                        difficulty_level, language_level)
            
        print(f"Selected language level: {language_level}")
